                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h5>Wallet Balance:- <i class='fas fa-rupee-sign'></i> @php $bal=DB::table('members')->where('status','=','yes')->where('id','=',session('members_id'))->select('wallet_bal','level_eligibility','withdrawal_eligibility')->get(); echo $bal[0]->wallet_bal @endphp</h5>
                                    @if($bal[0]->withdrawal_eligibility=='yes')
                                    <div class="col-md-6">
                                    ...
                                    <p style="color: red;">*Minimum withdrawal limit:-<i class='fas fa-rupee-sign'></i> {{$limit[0]->min_withdrawal_bal}}</p>
